...
-- 开始执行
-- ngx.log(ngx.ERR, get_file_dir(ngx.var.img_file));

local gm_path = 'gm'

-- check image dir
if not is_dir(get_file_dir(ngx.var.img_file)) then
    os.execute("mkdir -p " .. get_file_dir(ngx.var.img_file))
end
